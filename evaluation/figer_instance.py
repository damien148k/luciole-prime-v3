...
def main():
    ...
    lignes += [
        ...
        "-" * 78,
        "  Rejouer le bras question brute plus consigne sur le meme jeu de",
        "  vingt remarques. Repere mesure le 6 aout 2026 : zero esquive,",
        "  neuf bons tomes sur dix, environ quatorze minutes, et dix-neuf",
        "  reponses identiques au caractere sur vingt entre deux passages.",
        "  Tout ecart superieur a un cas signale une configuration differente,",
        "  pas du bruit.",
    ]
